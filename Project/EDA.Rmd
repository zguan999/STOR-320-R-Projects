...
crime=dplyr::select(crime,-c('Weapon Used Code'))
...
set.seed(216)
cvmod.0=cv.glmnet(y=as.factor(crime$'Victim Sex'),x=as.matrix(crime[,-1]),alpha=0,
                  family="binomial",type.measure="class")
set.seed(216)
cvmod.25=cv.glmnet(y=as.factor(crime$'Victim Sex'),x=as.matrix(crime[,-6]),alpha=0.25,
                   family="binomial",type.measure="class")
set.seed(216)
cvmod.5=cv.glmnet(y=as.factor(crime$'Victim Sex'),x=as.matrix(crime[,-6]),alpha=0.5,
                  family="binomial",type.measure="class")
set.seed(216)
cvmod.75=cv.glmnet(y=as.factor(crime$'Victim Sex'),x=as.matrix(crime[,-6]),alpha=0.75,
                   family="binomial",type.measure="class")
set.seed(216)
cvmod.1=cv.glmnet(y=as.factor(crime$'Victim Sex'),x=as.matrix(crime[,-6]),alpha=1,
                  family="binomial",type.measure="class")
